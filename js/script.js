...
(function ($) {
    ...
    //Center Modal and display image
    ...
    //modal image picture 
    function imgSelect(){
        var $original = $(this).find(".portfolio-item-picture");
        var src = $original.attr('src');
        $('#resModPic').attr('src', src);
    }
    $('.modImage').on('click', imgSelect)
...
//filter button click on the portfolio page
    $(".fil").click(function () {
        ...
        //fade entire section
        $(".port-section").fadeTo(100, 0.1);
        //fade not selected class
        $(".port-section .pItem").not("." + selectedClass).hide();
        setTimeout(function () {
